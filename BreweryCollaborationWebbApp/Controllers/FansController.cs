...
namespace BreweryCollaborationWebbApp.Controllers
{
    public class FansController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,State,Zipcode,Email,ApplicationId,ApplicationUser,latitude,longitude")] Fan fan)
        //{
        //    if (id != fan.Id)
        //    {
        //        return NotFound();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, BeerFanTasteViewModel beerFanTasteViewModel, Fan fan)
        {
            if (id != fan.Id)
            {
                return NotFound();
